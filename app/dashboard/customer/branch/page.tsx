                                ...
                                <form onSubmit={addAdmin}>
                                    <div className="grid gap-4 py-4">
                                        <div className="grid grid-cols-4 items-center gap-4">
                                            ...
                                            <Input type="email" name="email" placeholder="Enter Admin Email..." id="email" className="col-span-3" />
                                        </div>
                                        <div className="grid grid-cols-4 items-center gap-4">
                                            <Label htmlFor="vesselName" className="text-right">
                                                Branch Id
                            ...
                            <form onSubmit={addEmployee}>
                                <div className="grid gap-4 py-4">
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        <Input type="email" name="email" placeholder="Enter Manager Email..." id="email" className="col-span-3" />
                                    </div>
                            ...
                            <DialogContent>
                                ...
                                <div className="grid gap-4 py-4">
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        <Input id="vesselName" placeholder="Enter Branch Name..." value={newBranch.name} onChange={(e) => setNewBranch({ ...newBranch, name: e.target.value })} className="col-span-3" />
                                    </div>
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        <Label htmlFor="vesselName" className="text-right">
                                            Select Vessels
                                ...
                                <DialogFooter>
                                    <Button type="submit" onClick={addBranch}>Add Branch</Button>
                                </DialogFooter>
                            </DialogContent>
                        </Dialog>
                            ...
                            <DialogContent>
                                ...
                                <div className="grid gap-4 py-4">
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        <Input id="vesselName" placeholder="Enter Vessel Name..." value={vesselName} onChange={(e) => setVesselName(e.target.value)} className="col-span-3" />
                                    </div>
                                </div>

                                <DialogFooter>
                                    <Button type="submit" onClick={addVessel}>Add Vessel</Button>
                                </DialogFooter>
                            </DialogContent>
                        </Dialog>
                    </div>
