    ...
    <>
      ...
      <td>
        <div className="flex gap-2">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select
                    onValueChange={(value) =>
                      setNewBranch((prev) => ({
                        ...prev,
                        vessels: prev.vessels.includes(value)
                          ? prev.vessels
                          : [...prev.vessels, value], // Prevent duplicates
                      }))
                    }
                  >
                    <SelectTrigger className="w-[180px]">
          ...
          <Link
            href={`/dashboard/customer/branch/${branch.id}`}
            className="grid"
          >
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {branches.map((branch, i) => (
              <tr key={i}>
                <BranchCard branch={branch} vessels={vessels} />
              </tr>
            ))}
          </tbody>
        </table>
