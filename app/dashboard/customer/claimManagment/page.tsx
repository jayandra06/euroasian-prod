  ...
  const fetchRfqs = useCallback(async () => {
    ...
    try {
      ...
      const flattenedData = rfqsData.map((item: any) => ({
        ...
        vendor_name: item.merchant?.name || "Unknown Vendor",
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem asChild>
                              <Link
                                href={`/dashboard/customer/claimManagment/viewOrderDetails/${rfq.rfq_id}`}
                                className="w-full"
                              >
                                View
                              </Link>
