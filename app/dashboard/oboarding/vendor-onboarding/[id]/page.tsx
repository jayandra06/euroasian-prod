        ...
        <div className="bg-white rounded-xl shadow-md p-8">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <Label className="text-gray-700">Managing Director Email</Label>{" "}
                <span className="text-red-500">*</span>
                <Input
                  type="email"
          ...
          <div className="mt-8">
            <Button className="bg-blue-500 hover:bg-blue-700 flex justify-center text-white font-bold py-3 px-6 rounded-md focus:outline-none focus:shadow-outline">
              Become a Vendor
            </Button>
          </div>
        </div>
